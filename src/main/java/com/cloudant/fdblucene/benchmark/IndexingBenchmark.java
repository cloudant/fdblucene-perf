...
public class IndexingBenchmark {
    ...
    public static abstract class AbstractIndexingBenchmark {
        ...
        public long indexing() throws Exception {
            final Document doc = docMaker.makeDocument();
        ...
        public void setup() throws Exception {
            ...
            properties.setProperty(
                    "docs.file",
                    "/Users/robertnewson/Downloads/enwiki-20190120-pages-articles-multistream.xml");
            Config config = new Config(properties);

            final ContentSource contentSource = new EnwikiContentSource();
