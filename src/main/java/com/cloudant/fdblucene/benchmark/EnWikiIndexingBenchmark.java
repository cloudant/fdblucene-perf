...
public class EnWikiIndexingBenchmark {
    ...
    @Benchmark
    public long indexFDB(FDBIndexingSetup setup) throws Exception {
    ...
    @OutputTimeUnit(TimeUnit.SECONDS)
    @Benchmark
    public long indexNIOS(NIOSIndexingSetup setup) throws Exception {
        Document doc = setup.docMaker.makeDocument();
        return setup.writer.addDocument(doc);
    }

    public static void main(final String[] args) throws RunnerException {
        final Options opt = new OptionsBuilder().include(EnWikiIndexingBenchmark.class.getSimpleName()).build();
        new Runner(opt).run();
    }
